...
| Doc | Purpose |
|---|---|
| [`paper/review_manuscript.md`](../../paper/review_manuscript.md) | Full source-of-truth manuscript (~118 KB) |
| [`paper/submit_ready.md`](../../paper/submit_ready.md) | 9-page autocut version |
| [`paper/submit_ready_supplementary.md`](../../paper/submit_ready_supplementary.md) | Supplementary markdown (refs + appendices) |
| [`paper/results_manifest.csv`](../../paper/results_manifest.csv) | All numeric results, one row per (run, condition, seed) tuple |
| [`paper/phase_e_summary.{md,json}`](../../paper/phase_e_summary.md) | Per-fold and overall Phase E summary |
| [`paper/RELATED_WORK_SUMMARY.md`](../../paper/RELATED_WORK_SUMMARY.md) | All 31 cited papers — links, summaries, comparisons |
