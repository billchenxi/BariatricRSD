...
- 98% of paired conditioning-effect variance is between-fold, 2%
  ...
  split at any seed count. ([finding](paper2_planning/phase_0/PHASE_0_FINDING_FOLD_VARIANCE.md))
- The k-means phase-order cluster id is seed-unstable (ARI 0.63) and not
  ...
  ([finding](paper2_planning/phase_0/PHASE_0_FINDING_REPRESENTATION.md))
...
Full documents in [`paper2_planning/phase_0/`](paper2_planning/phase_0/).
